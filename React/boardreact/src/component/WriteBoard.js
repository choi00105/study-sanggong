            ...
            <div className="WriteDiv">
                ...
                <form id="WriteForm" method="POST">
                    ...
                    <div className="fileuploadForm">
                        <input type="file" ref={fileEventRef} style={{display:'none'}} onChange={(e) => fileEvent(e)} multiple />
                        <div className="fileZone" ref={fileZoneRef} onClick={(e) => fileZoneClick(e)}> 파일 첨부를 하기 위해서는 클릭하거나 여기로 파일을 드래그 하세요.<br/>첨부파일은 최대 5개까지 등록이 가능합니다.</div>
